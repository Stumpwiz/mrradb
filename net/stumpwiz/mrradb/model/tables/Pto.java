...
public class Pto extends TableImpl<PtoRecord> {
     ...
     */
    @Override
    public Pto where(Condition condition) {
        return new Pto(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Pto where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Pto where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Pto where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Pto where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Pto where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Pto where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Pto where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Pto whereExists(Select<?> select) {
     ...
     */
    @Override
    public Pto whereNotExists(Select<?> select) {
